...
import ListTopSection from '../components/List/ListTopSection';
          ...
          {noData ?
            ...
            <div className="py-2 px-10">
              ...
              <div className="">
                ...
                <table className="p-5 bg-white dark:bg-[#131920] dark:!text-gray-100 w-full max-md:w-[100%]  mt-6 ">
                  <thead className='mt-10'>
                    <tr className=" uppercase leading-normal w-[100%]">
                      ...
                      <ListHead headerStyle="py-[2%] pl-[2rem]" heading="Name" handleSorting={handleSorting} headingIndex={1} sortDirection={sortDirection} sortIndex={sortIndex} />
                      <ListHead headerStyle="pl-[2rem]" heading="Phone" handleSorting={handleSorting} headingIndex={2} sortDirection={sortDirection} sortIndex={sortIndex} />
                      <ListHead headerStyle="pl-6" spanStyle="ml-auto" heading="Age" handleSorting={handleSorting} headingIndex={3} sortDirection={sortDirection} sortIndex={sortIndex} />
                      <ListHead headerStyle="" spanStyle="ml-auto" heading="Salary" handleSorting={handleSorting} headingIndex={4} sortDirection={sortDirection} sortIndex={sortIndex} />
                      <ListHead headerStyle="" spanStyle="m-auto" heading="Status" />
                      <ListHead headerStyle="" spanStyle="m-auto" heading="Action" />
                    </tr>

                  </thead>

                  {sortedData?.map((value, index) => (
                    <tbody className="text-[#000000] dark:text-gray-100 text-sm font-light w-[100%] bg-white dark:bg-gray-700" key={value.id} >
                      <tr className='' >
                        {/* <td className="py-[2%] w-[3%]   border-r-[1px] border-t-[1px] text-center">
                          <span className="font-bold max-md:text-[.7rem] text-[13px] text-blue-500">{value.id}</span>
                        </td> */}
                        <td className="py-[2%] w-[10%] pl-[2rem]  border-r-[1px] border-l-[1px] border-t-[1px] dark:!border-blue-300   text-left">
                          <span className=" max-md:text-[.7rem] text-[14px] font-[500]">{value.name}</span>
                          <p className=" max-md:text-[.7rem] text-[13px] font-[350] text-gray-600 dark:!border-blue-300  dark:text-gray-100">{value.email}</p>
                        </td>
                        <td className="py-[2%] w-[10%] pl-[2rem]  border-r-[1px] border-t-[1px] dark:!border-blue-300  text-left">
                          <span className=" max-md:text-[.7rem] text-[12px] font-[500]">{value.phone}</span>
                        </td>
                        <td className="py-[2%] w-[10%]   border-r-[1px] border-t-[1px]  dark:!border-blue-300  text-center">
                          <span className=" max-md:text-[.7rem] text-[13px] font-[350]">{value.age}</span>
                        </td>
                        <td className="py-[2%] w-[10%] pr-[1.2rem]  border-r-[1px] border-t-[1px] dark:!border-blue-300  text-right">
                        ...
                        <td className="py-[2%] w-[2%] max-md:text-[.7rem]  border-r-[1px] border-t-[1px] dark:!border-blue-300   text-center">
                ...
                <div className="h-[3rem] w-full px-10 bg-gray-200 dark:bg-gray-500 flex justify-between items-center" >
                  <div className="flex items-center gap-5 ml-auto" >
                    {/* <p>1 - {itemPerPage === 'ALL' ? 'ALL' : itemsPerPage}</p> */}
                    <select className="px-2 !rounded-md  focus:outline-none border-[1px] border-sky-500  cursor-pointer"
                    ...
                    <p className='dark:text-gray-200'>Entries Per Page</p>
                  </div>
                </div>
              </div>
            </div>

...
const Sidebar = forwardRef(({ }, ref) => {
  ...
  const handleStyle = (name) => {
    if (location.pathname === `/${name}`) {
      if (name != null) {
        return "px-2 py-3 mx-5 rounded-xl mt-2 text-center cursor-pointer mb-1 flex items-center bg-[#E8F7FE] text-[#42A9F5]";
      }
    }
    else {
      return "px-2 py-3 mx-5 rounded-xl mt-2 text-center cursor-pointer mb-1 flex items-center text-gray-700 font-[600] hover:bg-gray-100";
    }
  };
  ...
  return (
    <div ref={ref} className="mt-[-4rem] fixed w-[16rem] h-full bg-white rounded-r-[1.4rem] shadow-sm max-md:w-[40%] overflow-auto no-scrollbar" >
      <>
        ...
        <div className="bg-white fixed bottom-0 w-[14rem] mt-10 ">
          <div className='px-2 py-3 mx-5 rounded-xl text-center cursor-pointer flex items-center text-gray-700 font-[600] hover:bg-gray-100'>
